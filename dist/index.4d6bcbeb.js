...
root.append(new (0, _appDefault.default)().element);
...
},{"./core":"fyiI3","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fyiI3":[function(require,module,exports) {
///컴포넌트 생성///
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class Store {
    constructor(state){
        this.state = {};
        this.observers = {};
        for(const key in state)Object.defineProperties(this.state, key, {
            get: ()=>state[key],
            set: (val)=>{
                state[key] = val;
    ...
    //state값 변경시 콜백 함수 실행
    subscribe(key, cb) {
        Array.isArray(this.observers[key]) ? this.observers[key].push(db) //함수가 여러 개일때
         : this.observers[key] = [
            cb
        ];
    }
